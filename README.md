...
![bmake.vim's syntax highlighting sample:](.imgs/bmake.png)
![Vim's default make syntax highlighting sample:](.imgs/make.png)

---
Licence: Same licence as Vim if to be shipped with it, BSD 4-clause in all
other cases. 
